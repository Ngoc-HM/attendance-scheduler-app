"""Auto comp-day off — force each person to use up last month's comp debt.
...
The solver picks the optimal days (§5.4 — placement left to optimization).
"""
